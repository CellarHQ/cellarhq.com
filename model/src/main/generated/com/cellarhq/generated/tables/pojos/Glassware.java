...
public class Glassware implements Serializable {

    private static final long serialVersionUID = -1056850378;
    ...
    public Glassware(Glassware value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Glassware (");
