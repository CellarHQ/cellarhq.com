<?php include 'inc/config.php'; $template['header_link'] = 'UI LAYOUTS'; $template['header'] = 'navbar-fixed-top'; ?>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="header-section">
                    <h1>Top Header + Sidebars (Fixed)</h1>
                </div>
            </div>
            <div class="col-sm-6 hidden-xs">
                <div class="header-section">
                    <ul class="breadcrumb breadcrumb-top">
                        <li>UI Layouts</li>
                        <li><a href="">Top Header (Fixed)</a></li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <!-- END Top Header (Fixed) Header -->
