<?php include 'inc/config.php'; $template['header_link'] = 'UI LAYOUTS'; $template['header'] = ''; $template['sidebar'] = 'sidebar-visible-lg-mini'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Mini Sidebar (Static) Header -->
    <div class="content-header">
        <div class="row">
            <div class="col-sm-6">
                <div class="header-section">
                    <h1>Mini Sidebar (Static)</h1>
                </div>
            </div>
            <div class="col-sm-6 hidden-xs">
                <div class="header-section">
                    <ul class="breadcrumb breadcrumb-top">
                        <li>UI Layouts</li>
                        <li><a href="">Mini Sidebar (Static)</a></li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <!-- END Mini Sidebar (Static) Header -->
            ...
            <div class="col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3">
                <article>
                    <div class="text-center">
                        <img src="img/placeholders/avatars/avatar9.jpg" alt="image" class="img-circle">
                        <h3 class="sub-header text-right">
                            <a href="javascript:void(0)" class="pull-left"><strong>John Doe</strong></a>
                            <small class="text-muted"><em>August 25, 2014</em></small>
                        </h3>
                    </div>
                    ...
                    <div class="row push-top-bottom">
                        ...
                        <div class="col-xs-6 push">
                            <img src="img/placeholders/photos/photo12.jpg" alt="image" class="img-responsive center-block">
                        </div>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh sapien in purus. Mauris tincidunt tincidunt turpis in porta. Integer fermentum tincidunt auctor. Vestibulum ullamcorper, odio sed rhoncus imperdiet, enim elit sollicitudin orci, eget dictum leo mi nec lectus. Nam commodo turpis id lectus scelerisque vulputate. Integer sed dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et lectus? Etiam egestas fringilla enim, id convallis lectus laoreet at. Fusce purus nisi, gravida sed consectetur ut, interdum quis nisi. Quisque egestas nisl id lectus facilisis scelerisque?</p>
